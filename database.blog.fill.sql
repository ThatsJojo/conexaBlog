...
VALUES (@selectedUSER, NOW(), 'Novo módulo de integração com Banco Inter: entenda as vantagens', 'published', 'html', NOW(), '<div class="post-4551 post type-post status-publish format-standard has-post-thumbnail hentry category-coworkings">
